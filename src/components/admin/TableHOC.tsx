...
function TableHOC<T extends {}>(columns: Column<T>[],data: T[], containerClassname: string, heading: string
  ...
  return function HOC() {
    ...
    const {getTableProps,getTableBodyProps,headerGroups,page,prepareRow,nextPage,previousPage,pageCount,state:{pageIndex}
    ,canNextPage,canPreviousPage}=useTable(options,useSortBy,usePagination);
    return (
